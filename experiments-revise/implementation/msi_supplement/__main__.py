...
def _parser() -> argparse.ArgumentParser:
    ...
    run.add_argument("--setup-timeout", type=_positive, default=900,
                     help="Provider upload/durable-creation socket I/O timeout in seconds; query timeout stays 30 (default: 900)")
